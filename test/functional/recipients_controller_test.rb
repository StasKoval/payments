...
class RecipientsControllerTest < ActionController::TestCase
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post :create, recipient: { address: @recipient.address, contacts: @recipient.contacts, name: @recipient.name }
    end
  ...
  test "should update recipient" do
    put :update, id: @recipient, recipient: { address: @recipient.address, contacts: @recipient.contacts, name: @recipient.name }
    assert_redirected_to recipient_path(assigns(:recipient))
  end
